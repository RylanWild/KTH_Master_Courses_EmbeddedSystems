...
procedure rms2 is
   ...
   Start : Time; -- Start Time of the System
	Calibrator: constant Integer := 700; -- Calibration for correct timing original:850
...
-- Main Program: Terminates after measuring start time	
	...
	Task_2 : T(2, 19, Warm_Up_Time, 400, 100, 400); -- ID: 2
	                                                   -- Priority: 19
                                                      --	Phase: Warm_Up_Time (100)
	                                                   -- Period 400, 
	                                                   -- Computation Time: 100 (if correctly calibrated) 
	...
	Task_3 : T(3, 18, Warm_Up_Time, 600, 100, 600); -- ID: 3
	                                                   -- Priority: 18
                                                      --	Phase: Warm_Up_Time (100)
	                                                   -- Period 600, 
	                                                   -- Computation Time: 100 (if correctly calibrated) 
	...
	Task_4 : T(4, 17, Warm_Up_Time, 1200, 200, 1200); -- ID: 4
	                                                   -- Priority: 17
                                                      --	Phase: Warm_Up_Time (100)
	                                                   -- Period 1200, 
