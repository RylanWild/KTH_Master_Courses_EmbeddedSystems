...
procedure overloaddetection is
   ...
   Start : Time; -- Start Time of the System
	Calibrator: constant Integer := 900; -- Calibration for correct timing
											--2000 correct timing
   ...
   task type WatchDog(Prio: Integer; Phase: Integer; Period: Integer) is
   ...
   WDT : WatchDog(20, Warm_Up_Time, 1200);
   ...
   -- NOTE: All tasks should have a minimum phase, so that they have the same time base!
    ...
    Task_1 : T(1, 19, Warm_Up_Time, 300, 100, 300);    -- ID: 1
	                                                   -- Priority: 20
                                                       -- Phase: Warm_Up_Time (100)
	                                                   -- Period 300, 
	                                                   -- Computation Time: 100 (if correctly calibrated) 
	                                                   -- Relative Deadline: 300
	Task_2 : T(2, 18, Warm_Up_Time, 400, 100, 400);    -- ID: 2
	                                                   -- Priority: 19
                                                       -- Phase: Warm_Up_Time (100)
	                                                   -- Period 400, 
	                                                   -- Computation Time: 100 (if correctly calibrated) 
	                                                   -- Relative Deadline: 400
    Task_3 : T(3, 17, Warm_Up_Time, 600, 100, 600);    -- ID: 3
	                                                   -- Priority: 18
                                                       -- Phase: Warm_Up_Time (100)
	                                                   -- Period 600, 
	                                                   -- Computation Time: 100 (if correctly calibrated) 
	                                                   -- Relative Deadline: 600
    Task_4 : T(4, 16, Warm_Up_Time, 1200, 200, 1200);  -- ID: 4
	                                                   -- Priority: 17
                                                       -- Phase: Warm_Up_Time (100)
	                                                   -- Period 1200, 
	                                                   -- Computation Time: 100 (if correctly calibrated) 
	                                                   -- Relative Deadline: 1200
    Helper_T: T(5, 10, Warm_Up_Time, 1200, 1, 1200);
	

--	task type HelperTask is 
--		pragma Priority(15); 
--	end;
--	task body HelperTask is
--	begin
--		WDT.Reset;
--	end HelperTask;
--
